    ...
    <section className="section-padding bg-cream">
      <div className="container-premium">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
          <div>
            <span className="kicker mb-6">Explore Our Work</span>
            <h2 className="text-4xl md:text-5xl font-serif text-dark max-w-lg">
              Three paths into our mission
            </h2>
          </div>
          <p className="text-dark/55 max-w-sm leading-relaxed">
            Start where you feel most moved — learn who we are, give your time, or follow
            the journeys of children we serve.
          </p>
        </div>
                ...
                <div className="card-premium overflow-hidden h-full flex flex-col">
                  <div className="relative aspect-[4/3] overflow-hidden">
                    <Image
                      src={
                        program.index === '01'
                          ? 'https://images.unsplash.com/photo-1497486751826-5bc8bce4f3f6?auto=format&fit=crop&w=900&q=80'
                          : program.index === '02'
                            ? 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=900&q=80'
                            : 'https://images.unsplash.com/photo-1509099836639-18ba1795216d?auto=format&fit=crop&w=900&q=80'
                      }
                      alt={`${program.title} — Rescue Mission Orphanage`}
                      fill
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    <div className="flex items-center gap-4 mb-5">
                      ...
                      <div>
                        <p className="text-xs uppercase tracking-[0.2em] text-dark/45 font-medium">{program.subtitle}</p>
                        <h3 className="text-2xl font-serif text-dark group-hover:text-dark-100 transition-colors">{program.title}</h3>
                      </div>
                    </div>
                    <p className="mt-3 text-dark/55 leading-relaxed flex-1">{program.description}</p>
